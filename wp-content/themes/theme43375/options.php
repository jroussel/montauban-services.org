...
if(!function_exists('optionsframework_options')) {
	...
	function optionsframework_options() {
		...
		// Logo type
		$logo_type = array(
			"image_logo" => __("Image Logo", CURRENT_THEME),
			"text_logo" => __("Text Logo", CURRENT_THEME)
		);
		...
		$options['h2_heading'] = array( 'name' => 'H2 Heading',
							...
							'id' => 'h2_heading',
							'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#7edafd'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['h3_heading'] = array( 'name' => 'H3 Heading',
							...
							'id' => 'h3_heading',
							'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#c3d108'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['h4_heading'] = array( 'name' => 'H4 Heading',
							...
							'id' => 'h4_heading',
							'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#fc8a57'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['g_twitter_box_id'] = array( "name" => "Display twitter box?",
							"desc" => "Display twitter box in the header?",
							"id" => "g_twitter_box_id",
							"type" => "radio",
							"std" => "yes",
							"options" => $g_twitter_box);

		$options['g_twitter_link'] = array( "name" => "Twitter link",
                            "desc" => "Twitter link",
                            "id" => "g_twitter_link",
                            "std" => "lorem_ipsum_dol",
                            "class" => "tiny",
...
if(!function_exists('cherry_register')) {
	...
	function cherry_register($wp_customize) {
		...
		$wp_customize->add_section( 'cherry_header', array(
			'title' => __( 'General', CURRENT_THEME ),
			'priority' => 200
		));
